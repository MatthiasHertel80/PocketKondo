...
local L = {
    ...
    MARK_CONSUMABLES_LABEL = "Mark usable consumables in bags",
    ...
    TOOLTIP_MARK_CONSUMABLES = "Show a green potion icon on usable consumables (potions, food, scrolls) so you can use them up and free bag space.",
...
if GetLocale() == "deDE" then
    ...
    L.MARK_CONSUMABLES_LABEL = "Verbrauchbare Items in Taschen markieren"
    ...
    L.TOOLTIP_MARK_CONSUMABLES = "Zeigt ein gruenes Trank-Symbol auf verbrauchbaren Items (Traenke, Essen, Schriftrollen), damit du sie aufbrauchen und Platz schaffen kannst."
